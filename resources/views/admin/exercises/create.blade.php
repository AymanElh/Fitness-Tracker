...
@section('content')
    <div class="p-6 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
        <div class="max-w-4xl mx-auto">
            ...
            <div
                class="bg-white rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-300 hover:scale-[1.01]">
                <!-- Form Header -->
                <div class="bg-gradient-to-r from-blue-500 to-purple-600 text-white p-8">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-3xl font-extrabold mb-2 tracking-tight">Add an Exercise</h1>
                            <p class="text-sm opacity-80">Create a new exercise by filling in the information below.</p>
                        </div>
                    </div>
                </div>
                ...
                <form action="#" method="POST" enctype="multipart/form-data" class="p-8 space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2">
                            <label for="name" class="block text-sm font-semibold text-gray-700 mb-2">Exercise
                                Name</label>
                            <input
                                type="text"
                                name="name"
                        ...
                        <!-- Difficulty -->
                        <div>
                            <label for="difficulty" class="block text-sm font-semibold text-gray-700 mb-2">Difficulty
                                Level</label>
                            <div class="relative">
                                <select
                                    name="difficulty"
                        ...
                        <!-- Calories -->
                        <div>
                            <label for="calories" class="block text-sm font-semibold text-gray-700 mb-2">Calories
                                Burned</label>
                            <div class="relative">
                                <input
                                    type="number"
                        ...
                        <!-- Video Upload -->
                        <div class="col-span-2">
                            <label for="video" class="block text-sm font-semibold text-gray-700 mb-2">Demonstration
                                Video</label>
                            <div
                                class="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-blue-400 transition-all group">
                                <svg
                                    class="mx-auto h-16 w-16 text-gray-400 group-hover:text-blue-500 transition-colors mb-4"
                                ...
                                <div class="text-sm text-gray-600">
                                    <label
                                        class="relative cursor-pointer text-blue-600 hover:text-blue-700 font-semibold">
                                        Upload a video
                                        <input
                                            type="file"
                                            name="video"
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">MP4, WebM up to 50MB</p>
                                </div>
                            </div>
                        </div>
                    </div>
