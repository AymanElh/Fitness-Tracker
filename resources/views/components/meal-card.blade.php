<div class="card-gradient rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300">
    ...
    <div class="p-5">
        <div class="flex justify-between items-center mb-2">
            ...
            <span class="px-3 py-1 rounded-full bg-green-500/20 text-green-400 text-xs font-semibold">{{ $category }}</span>
        </div>
        <p class="text-gray-400 text-sm mb-3">{{ $description }}</p>
        <div class="flex justify-between items-center">
            <span class="text-gray-400 flex items-center"><i class="fas fa-fire mr-2"></i>{{ $calories }} cal</span>
            <a href="#" class="text-blue-400 hover:underline flex items-center">Recipe <i class="fas fa-chevron-right ml-1 text-xs"></i></a>
        </div>
    </div>
</div>
