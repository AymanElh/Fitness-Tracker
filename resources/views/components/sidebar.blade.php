        ...
        <div class="flex flex-col w-72 bg-gradient-to-b from-gray-800 to-gray-900 shadow-xl">
            <div class="flex flex-col h-0 flex-1">
                ...
                <nav class="flex-1 px-4 py-4 space-y-2 overflow-y-auto">
                    ...
                    <a href="#" class="group flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white transition-colors duration-200  {{ isActive('admin.users') }}">
                    ...
                    <a href="#" class="group flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white transition-colors duration-200  {{ isActive('admin.exercises') }}">
                        <svg class="mr-3 h-6 w-6 text-gray-400 group-hover:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {{-- <a href="#" class="group flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white transition-colors duration-200">
                        <svg class="mr-3 h-6 w-6 text-gray-400 group-hover:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="#" class="group flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white transition-colors duration-200 {{ isActive('admin.meals') }}">
                        <svg class="mr-3 h-6 w-6 text-gray-400 group-hover:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="flex-shrink-0 w-full group block">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                ...
                                <a href="#" class="text-xs font-medium text-gray-300 hover:text-gray-200 transition-colors duration-200">
                                    Logout
                                </a>
                            </div>
                        </div>
