        ...
        <div class="flex flex-col w-72 bg-gradient-to-b from-gray-800 to-gray-900 shadow-xl">
            <div class="flex flex-col h-0 flex-1">
                ...
                <nav class="flex-1 px-4 py-4 space-y-2 overflow-y-auto">
                    <a href="#" class="group flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white transition-colors duration-200 bg-gray-900 text-white">
